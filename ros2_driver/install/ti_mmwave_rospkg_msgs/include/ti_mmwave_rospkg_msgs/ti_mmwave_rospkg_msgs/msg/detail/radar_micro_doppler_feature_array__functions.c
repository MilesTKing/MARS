...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__init(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(msg);
    return false;
  }
  // num_tracks
  // track
  if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__Sequence__init(&msg->track, 0)) {
    ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(msg);
    return false;
  }
  return true;
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * msg)
{
  ...
  // num_tracks
  // track
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__Sequence__fini(&msg->track);
}
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__are_equal(const ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * lhs, const ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * rhs)
{
  ...
  // track
  if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__Sequence__are_equal(
      &(lhs->track), &(rhs->track)))
  {
    return false;
  }
  ...
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * output)
{
  ...
  // track
  if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__Sequence__copy(
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__create()
{
  ...
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * msg = (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray *)allocator.allocate(sizeof(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray));
  bool success = ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__init(msg);
  if (!success) {
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__init(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * data = NULL;

  if (size) {
    data = (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray *)allocator.zero_allocate(size, sizeof(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(&data[i - 1]);
      }
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__fini(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * array = (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence *)allocator.allocate(sizeof(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__init(array, size);
  if (!success) {
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__destroy(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence__are_equal(const ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * lhs, const ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * data =
      (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__copy(
