...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "ti_mmwave_rospkg_msgs/msg/detail/radar_classifier__type_support.h"
...
static void * ti_mmwave_rospkg_msgs__msg__radar_classifier__create_ros_message(void)
{
  return ti_mmwave_rospkg_msgs__msg__RadarClassifier__create();
}

static void ti_mmwave_rospkg_msgs__msg__radar_classifier__destroy_ros_message(void * raw_ros_message)
{
  ti_mmwave_rospkg_msgs__msg__RadarClassifier * ros_message = (ti_mmwave_rospkg_msgs__msg__RadarClassifier *)raw_ros_message;
  ti_mmwave_rospkg_msgs__msg__RadarClassifier__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool ti_mmwave_rospkg_msgs__msg__radar_classifier__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * ti_mmwave_rospkg_msgs__msg__radar_classifier__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarClassifier);

int8_t
_register_msg_type__msg__radar_classifier(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_classifier__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__radar_classifier",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_classifier__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__radar_classifier",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_classifier__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__radar_classifier",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_classifier__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__radar_classifier",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarClassifier),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__radar_classifier",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "ti_mmwave_rospkg_msgs/msg/detail/radar_micro_doppler_data_array__type_support.h"
...
static void * ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__create_ros_message(void)
{
  return ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataArray__create();
}

static void ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__destroy_ros_message(void * raw_ros_message)
{
  ...
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataArray__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerDataArray);

int8_t
_register_msg_type__msg__radar_micro_doppler_data_array(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__radar_micro_doppler_data_array",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__radar_micro_doppler_data_array",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__radar_micro_doppler_data_array",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_array__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__radar_micro_doppler_data_array",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerDataArray),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__radar_micro_doppler_data_array",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "ti_mmwave_rospkg_msgs/msg/detail/radar_micro_doppler_data_contents__type_support.h"
...
static void * ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__create_ros_message(void)
{
  return ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataContents__create();
}

static void ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__destroy_ros_message(void * raw_ros_message)
{
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataContents * ros_message = (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataContents *)raw_ros_message;
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataContents__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerDataContents);

int8_t
_register_msg_type__msg__radar_micro_doppler_data_contents(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__radar_micro_doppler_data_contents",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__radar_micro_doppler_data_contents",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__radar_micro_doppler_data_contents",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__radar_micro_doppler_data_contents",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerDataContents),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__radar_micro_doppler_data_contents",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "ti_mmwave_rospkg_msgs/msg/detail/radar_micro_doppler_feature_array__type_support.h"
...
static void * ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__create_ros_message(void)
{
  return ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__create();
}

static void ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__destroy_ros_message(void * raw_ros_message)
{
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray * ros_message = (ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray *)raw_ros_message;
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureArray__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerFeatureArray);

int8_t
_register_msg_type__msg__radar_micro_doppler_feature_array(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__radar_micro_doppler_feature_array",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__radar_micro_doppler_feature_array",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__radar_micro_doppler_feature_array",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_array__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__radar_micro_doppler_feature_array",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerFeatureArray),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__radar_micro_doppler_feature_array",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
static void * ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__create_ros_message(void)
{
  return ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__create();
}

static void ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__destroy_ros_message(void * raw_ros_message)
{
  ...
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerFeatureContents__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerFeatureContents);

int8_t
_register_msg_type__msg__radar_micro_doppler_feature_contents(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__radar_micro_doppler_feature_contents",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__radar_micro_doppler_feature_contents",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__radar_micro_doppler_feature_contents",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_feature_contents__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__radar_micro_doppler_feature_contents",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(ti_mmwave_rospkg_msgs, msg, RadarMicroDopplerFeatureContents),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__radar_micro_doppler_feature_contents",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyInit_ti_mmwave_rospkg_msgs_s__rosidl_typesupport_fastrtps_c(void)
{
  ...
  err = _register_msg_type__msg__radar_classifier(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
  ...
  err = _register_msg_type__msg__radar_micro_doppler_data_array(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__msg__radar_micro_doppler_data_contents(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__msg__radar_micro_doppler_feature_array(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__msg__radar_micro_doppler_feature_contents(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
