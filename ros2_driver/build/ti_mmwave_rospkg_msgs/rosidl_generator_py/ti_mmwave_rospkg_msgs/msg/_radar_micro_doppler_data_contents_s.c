...
bool ti_mmwave_rospkg_msgs__msg__radar_micro_doppler_data_contents__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ti_mmwave_rospkg_msgs.msg._radar_micro_doppler_data_contents.RadarMicroDopplerDataContents", full_classname_dest, 90) == 0);
  }
  ti_mmwave_rospkg_msgs__msg__RadarMicroDopplerDataContents * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of RadarMicroDopplerDataContents */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ti_mmwave_rospkg_msgs.msg._radar_micro_doppler_data_contents");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RadarMicroDopplerDataContents");
